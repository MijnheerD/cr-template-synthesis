...
for E, entry in enumerate(FIT_DIRECTORIES):
    ...
    for ind, (fileX, fileY) in enumerate(zip(fitFiles.filesX, fitFiles.filesY)):
        ...
        if simsPART[name][1]:
            ...
            parametersX.append([X_max, lineX['A'] / simsPART[name][0], lineX['b'], lineX['c'], P, proton])
            parametersY.append([X_max, lineY['A'] / simsPART[name][0], lineY['b'], lineY['c'], P, proton])
